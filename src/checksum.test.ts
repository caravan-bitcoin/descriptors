...
import { calculateChecksum, calculateDescriptorChecksum } from "./checksum";
...
describe("checksum", () => {
  ...
  describe("calculateChecksum", () => {
    it.each(tests)(
      ...
      async (name, descriptor, checksum) => {
        const calculatedChecksum = await calculateChecksum(descriptor);
